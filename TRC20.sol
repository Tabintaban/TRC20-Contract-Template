 ...
 *
 * Наконец, нестандартные {Уменьшение разрешения} и {увеличение разрешения}
 * добавлены функции для устранения хорошо известных проблем, связанных с настройкой
 * надбавки. Смотрите {ITRC20-одобрить}.
 */
